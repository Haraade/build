...
function run_kernel_make_internal() {
	...
	common_make_params_quoted=(
		...
		"KBUILD_BUILD_USER=am"                             # https://www.kernel.org/doc/html/latest/kbuild/kbuild.html#kbuild-build-user-kbuild-build-host
		"KBUILD_BUILD_HOST=rock"                           # https://www.kernel.org/doc/html/latest/kbuild/kbuild.html#kbuild-build-user-kbuild-build-host
